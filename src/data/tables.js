...
const pageVisits = [
    { id: 1, views: 4.525, returnValue: 255, bounceRate: 42.55, pageName: "FB" },
    { id: 2, views: 2.987, returnValue: 139, bounceRate: -43.52, pageName: "NFLX" },
    { id: 3, views: 2.844, returnValue: 124, bounceRate: -32.35, pageName: "CEQP" },
    { id: 4, views: 1.220, returnValue: 55, bounceRate: 15.78, pageName: "HEPA" },
    { id: 5, views: 505, returnValue: 3, bounceRate: -75.12, pageName: "TYG" }
];
